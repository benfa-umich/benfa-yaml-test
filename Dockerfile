...
RUN chown -R root:root /var/lock/apache2 /usr/local/etc/php \
	/usr/local/lib/php /var/log/apache2 \
	/var/run/apache2 /var/www/html
	
### Modify perms for the openshift user, who is not root, but part of root group.
RUN chmod -R g+r /var/www/html
RUN chmod -R g+rw /etc/apache2 /etc/apache2/mods-enabled \
	/etc/apache2/sites-enabled /etc/ssl/certs \
	/etc/ssl/private /var/log/apache2 \
	/var/www/html 
